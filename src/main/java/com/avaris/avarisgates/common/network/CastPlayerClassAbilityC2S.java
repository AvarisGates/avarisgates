...
public record CastPlayerClassAbilityC2S(PlayerClassAbilityType ability) implements CustomPayload {
    ...
    static {
        CODEC = new PacketCodec<>() {
            ...
            public CastPlayerClassAbilityC2S decode(PacketByteBuf buf) {
                return new CastPlayerClassAbilityC2S(PlayerClassAbilityType.fromInt(buf.readInt()));
            }
        ...
        PACKET_ID = AvarisGates.id("cast_player_class_ability");
