...
public class HudRenderer {
    public static void renderExperience(DrawContext context, RenderTickCounter tickCounter) {
        ...
        context.fill(screenWidth - width / 2 + 1,y + 1,screenWidth + width / 2 - 1,y + 10,Colors.BLACK);

        context.fill(screenWidth - width / 2 + 2,y + 2,screenWidth + width / 2 - 2,y + 9,Colors.YELLOW);
    }
